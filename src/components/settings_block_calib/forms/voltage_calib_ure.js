              ...
              <li
                ...
                <div className='item_input'>
                  ...
                  <FormInput
                    ...
                    direction="down"
                    label='▼'
                    name={`dac_admin_value_calib_down`}
                    clickHandler={() => {
                      let currentValue = parseInt(voltageCalibState.dac_admin_value) || 0;
                      let newValue = Math.max(currentValue - 10, 0);
                      setVoltageCalibState(prev => ({
                        ...prev,
