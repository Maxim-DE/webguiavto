...
import { MdDisplaySettings, MdOutlineInfo, MdOutlineMiscellaneousServices, MdOutlineSettingsInputComponent } from "react-icons/md";
...
const links_items = [
  ...
  { id: 'avr', name: "Управление устройствами", icon: <MdDisplaySettings size={30} />, req_access_level: 1 },
